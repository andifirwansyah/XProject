...
class HeaderBackButton extends React.PureComponent {
  ...
  _maybeRenderTitle() {
    ...
    return <Text onLayout={this._onTextLayout} style={[styles.title, !!tintColor && { color: tintColor }, titleStyle]} numberOfLines={1}>
        {backButtonTitle}
      </Text>;
  }
  ...
  render() {
    ...
    let button = <TouchableItem accessibilityComponentType="button" accessibilityLabel={title} accessibilityTraits="button" testID="header-back" delayPressIn={0} onPress={onPress} pressColor={pressColorAndroid} style={styles.container} borderless>
